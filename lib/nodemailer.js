...
import { numberWithCommas } from "./numberFormat.js";
import { formatDateTime, formatOnlyTime, addNHour } from "./dateFormatter.js";
              ...
              <div style="background-color: #f1f4ff; padding: 15px 20px; border-radius: 8px; margin-bottom: 25px;">
                ...
                : "Tidak tersedia"
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: top;"><strong>: ${data?.pickupDateTime && !data?.isDropOff
                ? `${formatDateTime(data?.pickupDateTime)} - ${formatOnlyTime(addNHour(data?.pickupDateTime, 2))} WIB`
                : "Bawa sendiri ke outlet"
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: top;"><strong>: ${data?.selfPickup
                ? "Diambil sendiri di outlet"
                : data?.deliveryDate
                    ? `${formatDateTime(data?.deliveryDate)} - ${formatOnlyTime(addNHour(data?.deliveryDate, 2))} WIB`
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;"><strong>: Rp ${numberWithCommas((data?.deliveryPrice || 0) - (data?.deliveryPriceDisc || 0))}</strong></td>
                    </tr>
                    <tr>
